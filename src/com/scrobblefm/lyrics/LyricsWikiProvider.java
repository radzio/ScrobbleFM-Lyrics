 ...
 * Date: 21.11.12
 * Time: 18:44
 * Based on Apollo by Andrew Neal (https://github.com/adneal/Apollo-CM)
 */
public class LyricsWikiProvider implements LyricsProvider
{
    ...
    public static String TAG = LyricsWikiProvider.class.getSimpleName();
    ...
    public String getLyrics(String artist, String song)
    {
        ...
        try
        {
            ...
            final String songURL = new JSONObject(urlString.replace("song = ", "")).getString("url");
        ...
        {
            Log.e(TAG, "Lyrics not found in " + getProviderName(), e);
        }
